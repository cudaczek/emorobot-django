...
def get_predictions_and_labels(audio_name, video_name, data_type):
    ...
    if data_type == DataType.EMOTIONS:
        ...
        results = get_predicted_emotions(audio_name, audio_predictor, receiver, video_name, video_predictor)
        results = get_final_predictions(results)
    ...
    audio_timestamp, video_timestamp = get_timestamps(receiver, audio_name, video_name, data_type)
    return {"audio_labels": audio_labels,
